...
<h1>Résultats de la recherche sur les individus (<?php echo $individusPager->getNbResults() ?>)
...
<div id="boutons">
    ...
    <a class="btnLightBlue" href="<?php echo url_for('@Individu_search') ?>"><img class="iconebtn16" alt="Effectuer une autre recherche" src="/images/boutons/search16.png"/>Nouvelle recherche</a>
    ...
    <a class="btnYellow" href="<?php echo url_for('@Individu_exportResults') ?>"><img class="iconebtn16" alt="Exporter les résultats" src="/images/boutons/download.png"/>Exporter résultats</a>
</div>
